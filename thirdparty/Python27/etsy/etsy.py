...
class Etsy(object):
    ...
    def __init__(self, storage, execution_interval, consumer_key, consumer_secret, permissions):
        ...
        self.permissions = self.storage.get('permissions', self.consumer_key).split(' ')

        if not self.oauth_token or not self.oauth_token_secret or len([x for x in permissions if x not in self.permissions])>0:
    ...
    def authorize(self, permissions):
        ...
        self.storage.api_call("/oauth/request_token")
        ...
        self.storage.api_call("/oauth/access_token")
    ...
    def execute(self, endpoint, method='get', oauth=None):
        ...
        self.storage.api_call(endpoint)
        
        ts = clock()
        if ts - self.last_execution_ts < self.execution_interval:
          sleep(self.last_execution_ts+self.execution_interval-ts)
    ...
    def findByIsoCodeExt(self, iso_code, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findByIsoCode"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findByIsoCode(iso_code, offset=cur_offset, limit=100)
    ...
    def findAllFeaturedTreasuriesExt(self, offset=0, limit=0, filterfunc=None, region='__ALL_REGIONS__'):
      """Wrapper for: findAllFeaturedTreasuries"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllFeaturedTreasuries(offset=cur_offset, limit=100, region=region)
    ...
    def findAllFeaturedListingsExt(self, offset=0, limit=0, filterfunc=None, region='__ALL_REGIONS__'):
      """Wrapper for: findAllFeaturedListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllFeaturedListings(offset=cur_offset, limit=100, region=region)
    ...
    def findAllFeaturedTreasuriesByOwnerExt(self, owner_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllFeaturedTreasuriesByOwner"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllFeaturedTreasuriesByOwner(owner_id, offset=cur_offset, limit=100)
    ...
    def findAllListingFavoredByExt(self, listing_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllListingFavoredBy"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllListingFavoredBy(listing_id, offset=cur_offset, limit=100)
...
be considered a digital listing."""
    ...
    def findAllListingTransactionsExt(self, listing_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllListingTransactions"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllListingTransactions(listing_id, offset=cur_offset, limit=100)
    ...
    def findAllListingActiveExt(self, offset=0, limit=0, filterfunc=None, category=None, min_price=None, lat=None, translate_keywords='false', accepts_gift_cards='false', tags=None, color=None, region=None, sort_on='created', lon=None, max_price=None, color_accuracy='0', sort_order='down', location=None, keywords=None, geo_level='city'):
      """Wrapper for: findAllListingActive"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllListingActive(offset=cur_offset, limit=100, category=category, min_price=min_price, lat=lat, translate_keywords=translate_keywords, accepts_gift_cards=accepts_gift_cards, tags=tags, color=color, region=region, sort_on=sort_on, lon=lon, max_price=max_price, color_accuracy=color_accuracy, sort_order=sort_order, location=location, keywords=keywords, geo_level=geo_level)
    ...
    def getInterestingListingsExt(self, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getInterestingListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getInterestingListings(offset=cur_offset, limit=100)
    ...
    def getTrendingListingsExt(self, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getTrendingListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getTrendingListings(offset=cur_offset, limit=100)
    ...
    def findAllPageCollectionsExt(self, page_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllPageCollections"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllPageCollections(page_id, offset=cur_offset, limit=100)
    ...
    def getCollectionListingsExt(self, page_id, collection_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getCollectionListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getCollectionListings(page_id, collection_id, offset=cur_offset, limit=100)
    ...
    def findPaymentAdjustmentsExt(self, payment_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findPaymentAdjustments"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findPaymentAdjustments(payment_id, offset=cur_offset, limit=100)
    ...
    def findPaymentAdjustmentItemExt(self, payment_id, payment_adjustment_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findPaymentAdjustmentItem"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findPaymentAdjustmentItem(payment_id, payment_adjustment_id, offset=cur_offset, limit=100)
    ...
    def findAllReceiptListingsExt(self, receipt_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllReceiptListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllReceiptListings(receipt_id, offset=cur_offset, limit=100)
    ...
    def findAllReceiptTransactionsExt(self, receipt_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllReceiptTransactions"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllReceiptTransactions(receipt_id, offset=cur_offset, limit=100)
    ...
    def findBrowseSegmentListingsExt(self, path, offset=0, limit=0, filterfunc=None, min_price=None, lat=None, accepts_gift_cards='false', sort_on='created', lon=None, max_price=None, ship_to=None, sort_order='down', location=None, keywords=None, geo_level='city'):
      """Wrapper for: findBrowseSegmentListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findBrowseSegmentListings(path, offset=cur_offset, limit=100, min_price=min_price, lat=lat, accepts_gift_cards=accepts_gift_cards, sort_on=sort_on, lon=lon, max_price=max_price, ship_to=ship_to, sort_order=sort_order, location=location, keywords=keywords, geo_level=geo_level)
    ...
    def findAllShippingTemplateEntriesExt(self, shipping_template_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShippingTemplateEntries"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShippingTemplateEntries(shipping_template_id, offset=cur_offset, limit=100)
    ...
    def findAllShopsExt(self, offset=0, limit=0, filterfunc=None, lon=None, shop_name=None, distance_max='35', lat=None):
      """Wrapper for: findAllShops"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShops(offset=cur_offset, limit=100, lon=lon, shop_name=shop_name, distance_max=distance_max, lat=lat)
    ...
    def findLedgerEntriesExt(self, shop_id, offset=0, limit=0, filterfunc=None, min_created=None, max_created=None):
      """Wrapper for: findLedgerEntries"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findLedgerEntries(shop_id, offset=cur_offset, limit=100, min_created=min_created, max_created=max_created)
    ...
    def findAllShopListingsActiveExt(self, shop_id, offset=0, limit=0, filterfunc=None, category=None, min_price=None, translate_keywords='false', tags=None, color=None, sort_on='created', max_price=None, color_accuracy='0', keywords=None, sort_order='down', include_private='0'):
      """Wrapper for: findAllShopListingsActive"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopListingsActive(shop_id, offset=cur_offset, limit=100, category=category, min_price=min_price, translate_keywords=translate_keywords, tags=tags, color=color, sort_on=sort_on, max_price=max_price, color_accuracy=color_accuracy, keywords=keywords, sort_order=sort_order, include_private=include_private)
    ...
    def findAllShopListingsDraftExt(self, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShopListingsDraft"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopListingsDraft(shop_id, offset=cur_offset, limit=100)
    ...
    def findAllShopListingsExpiredExt(self, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShopListingsExpired"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopListingsExpired(shop_id, offset=cur_offset, limit=100)
    ...
    def findAllShopListingsFeaturedExt(self, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShopListingsFeatured"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopListingsFeatured(shop_id, offset=cur_offset, limit=100)
    ...
    def findAllShopListingsInactiveExt(self, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShopListingsInactive"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopListingsInactive(shop_id, offset=cur_offset, limit=100)
    ...
    def findAllShopReceiptsExt(self, shop_id, offset=0, limit=0, filterfunc=None, min_created=None, was_shipped=None, was_paid=None, max_last_modified=None, max_created=None, min_last_modified=None):
      """Wrapper for: findAllShopReceipts"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopReceipts(shop_id, offset=cur_offset, limit=100, min_created=min_created, was_shipped=was_shipped, was_paid=was_paid, max_last_modified=max_last_modified, max_created=max_created, min_last_modified=min_last_modified)
    ...
    def findAllShopReceiptsByStatusExt(self, status, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShopReceiptsByStatus"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopReceiptsByStatus(status, shop_id, offset=cur_offset, limit=100)
    ...
    def searchAllShopReceiptsExt(self, search_query, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: searchAllShopReceipts"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.searchAllShopReceipts(search_query, shop_id, offset=cur_offset, limit=100)
    ...
    def getShopReviewsExt(self, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getShopReviews"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getShopReviews(shop_id, offset=cur_offset, limit=100)
    ...
    def findAllShopSectionListingsExt(self, shop_section_id, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShopSectionListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopSectionListings(shop_section_id, shop_id, offset=cur_offset, limit=100)
    ...
    def findAllShopSectionListingsActiveExt(self, shop_id, shop_section_id, offset=0, limit=0, filterfunc=None, sort_on='created', sort_order='down'):
      """Wrapper for: findAllShopSectionListingsActive"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopSectionListingsActive(shop_id, shop_section_id, offset=cur_offset, limit=100, sort_on=sort_on, sort_order=sort_order)
    ...
    def findAllShopTransactionsExt(self, shop_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllShopTransactions"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllShopTransactions(shop_id, offset=cur_offset, limit=100)
    ...
    def findAllTeamsExt(self, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllTeams"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllTeams(offset=cur_offset, limit=100)
    ...
    def findAllUsersForTeamExt(self, team_id, offset=0, limit=0, filterfunc=None, status='active'):
      """Wrapper for: findAllUsersForTeam"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUsersForTeam(team_id, offset=cur_offset, limit=100, status=status)
    ...
    def findAllTreasuriesExt(self, offset=0, limit=0, filterfunc=None, sort_on='hotness', sort_order='down', keywords=None):
      """Wrapper for: findAllTreasuries"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllTreasuries(offset=cur_offset, limit=100, sort_on=sort_on, sort_order=sort_order, keywords=keywords)
    ...
    def findTreasuryCommentsExt(self, treasury_key, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findTreasuryComments"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findTreasuryComments(treasury_key, offset=cur_offset, limit=100)
    ...
    def findAllUsersExt(self, offset=0, limit=0, filterfunc=None, keywords=None):
      """Wrapper for: findAllUsers"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUsers(offset=cur_offset, limit=100, keywords=keywords)
    ...
    def findAllUserAddressesExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserAddresses"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserAddresses(user_id, offset=cur_offset, limit=100)
    ...
    def getAllUserCartsExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getAllUserCarts"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getAllUserCarts(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserChargesExt(self, user_id, offset=0, limit=0, filterfunc=None, min_created=None, sort_order='up', max_created=None):
      """Wrapper for: findAllUserCharges"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserCharges(user_id, offset=cur_offset, limit=100, min_created=min_created, sort_order=sort_order, max_created=max_created)
    ...
    def getCirclesContainingUserExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getCirclesContainingUser"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getCirclesContainingUser(user_id, offset=cur_offset, limit=100)
    ...
    def getConnectedUserExt(self, to_user_id, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getConnectedUser"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getConnectedUser(to_user_id, user_id, offset=cur_offset, limit=100)
    ...
    def listFollowingPagesExt(self, offset=0, limit=0, filterfunc=None):
      """Wrapper for: listFollowingPages"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.listFollowingPages(offset=cur_offset, limit=100)
    ...
    def getConnectedUsersExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: getConnectedUsers"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.getConnectedUsers(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserFavoredByExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserFavoredBy"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserFavoredBy(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserFavoriteListingsExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserFavoriteListings"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserFavoriteListings(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserFavoriteUsersExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserFavoriteUsers"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserFavoriteUsers(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserFeedbackAsAuthorExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserFeedbackAsAuthor"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserFeedbackAsAuthor(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserFeedbackAsBuyerExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserFeedbackAsBuyer"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserFeedbackAsBuyer(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserFeedbackAsSellerExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserFeedbackAsSeller"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserFeedbackAsSeller(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserFeedbackAsSubjectExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserFeedbackAsSubject"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserFeedbackAsSubject(user_id, offset=cur_offset, limit=100)
    ...
    def findAllFeedbackFromBuyersExt(self, offset=0, limit=0, filterfunc=None, user_id=None):
      """Wrapper for: findAllFeedbackFromBuyers"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllFeedbackFromBuyers(offset=cur_offset, limit=100, user_id=user_id)
    ...
    def findAllFeedbackFromSellersExt(self, offset=0, limit=0, filterfunc=None, user_id=None):
      """Wrapper for: findAllFeedbackFromSellers"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllFeedbackFromSellers(offset=cur_offset, limit=100, user_id=user_id)
    ...
    def findAllUserPaymentsExt(self, user_id, offset=0, limit=0, filterfunc=None, min_created=None, sort_order='up', max_created=None):
      """Wrapper for: findAllUserPayments"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserPayments(user_id, offset=cur_offset, limit=100, min_created=min_created, sort_order=sort_order, max_created=max_created)
    ...
    def findAllUserBuyerReceiptsExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserBuyerReceipts"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserBuyerReceipts(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserShippingProfilesExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserShippingProfiles"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserShippingProfiles(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserShopsExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserShops"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserShops(user_id, offset=cur_offset, limit=100)
    ...
    def findAllTeamsForUserExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllTeamsForUser"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllTeamsForUser(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserBuyerTransactionsExt(self, user_id, offset=0, limit=0, filterfunc=None):
      """Wrapper for: findAllUserBuyerTransactions"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserBuyerTransactions(user_id, offset=cur_offset, limit=100)
    ...
    def findAllUserTreasuriesExt(self, user_id, offset=0, limit=0, filterfunc=None, sort_on='hotness', include_private='0', sort_order='down'):
      """Wrapper for: findAllUserTreasuries"""
      ...
      cur_offset = offset
      while True:
        raw_listings = self.findAllUserTreasuries(user_id, offset=cur_offset, limit=100, sort_on=sort_on, include_private=include_private, sort_order=sort_order)
